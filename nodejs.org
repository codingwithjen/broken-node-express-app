...
<head>
  ...
  <meta name="nodejs.org:node-version" content="v17.8.0">
  <title>Console | Node.js v17.8.0 Documentation</title>
    ...
    <div id="column1" data-id="console" class="interior">
      <header class="header">
        <div class="header-container">
          <h1>Node.js v17.8.0 documentation</h1>
...
<li><a href="https://github.com/nodejs/node" class="nav-https-github-com-nodejs-node">Code repository and issue tracker</a></li>
    ...
    <li class="picker-header">
      ...
      <div class="picker"><ol id="alt-docs"><li><a href="https://nodejs.org/docs/latest-v17.x/api/console.html">17.x</a></li>
...
<p><strong>Source Code:</strong> <a href="https://github.com/nodejs/node/blob/v17.8.0/lib/console.js">lib/console.js</a></p>
