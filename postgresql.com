...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2022-03-31T03:19:18.799647" />
  ...
  <link href="/media/css/fontawesome.css?11aaa66f" rel="stylesheet">
  <link rel="stylesheet" href="/media/css/bootstrap-4.4.1.min.css">
  <link rel="shortcut icon" href="/favicon.ico" />
  
    <link rel="stylesheet" type="text/css" href="/dyncss/base.css?11aaa66f">
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pgconfbe-call-for-papers-registration-open-2429/">PGConf.be : Call for Papers &amp; Registration open</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-03-29 by UCLL</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgbouncer-1170-released-2426/">PgBouncer 1.17.0 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-03-25 by Peter Eisentraut</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgadmin-4-v67-released-2423/">pgAdmin 4 v6.7 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-03-15 by pgAdmin Development Team</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/pgadmin-4-v66-released-2421/">pgAdmin 4 v6.6 Released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-03-15 by pgAdmin Development Team</li>
              </ul>
            </li>
            ...
            <li>
              <h3><a href="/about/news/postgresql-anonymizer-010-an-improved-engine-and-a-brand-new-tutorial-2424/">PostgreSQL Anonymizer 0.10: An improved engine and a brand new tutorial</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2022-03-15 by Dalibo</li>
              </ul>
            </li>
...
<!-- Blog -->
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5i2"> Creating cumulative sums by combining aggregation with windowing</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Regina Obe</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-03-30</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5i1"> How To Build Your Own PostgreSQL (and related software) RPMs on RHEL/Rocky/Fedora</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5i0"> Identify PostgreSQL Performance Bottlenecks With pg_stat_statements</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5h_"> Ultimate Guide to Citus Con: An Event for Postgres</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Claire Giordano</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-03-29</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5h-"> Installing Crunchy Postgres Operator v5 on EKS</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5hZ"> SQL/JSON in PG15 !</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Oleg Bartunov</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-03-29</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5hY"> How to DROP ROLE or DROP USER in PostgreSQL</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5hX"> Claire Giordano</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Andreas &#x27;ads&#x27; Scherbaum</li>
              <li><i class="far fa-clock"></i>&nbsp;2022-03-28</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/5hW"> Test drive the Citus 11.0 beta for Postgres</a></h3>
            <ul class="meta">
 ...
 <!-- END SUBMIT A BUG -->
    ...
    <script src="/media/js/main.js?11aaa66f"></script>
